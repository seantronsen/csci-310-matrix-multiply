/*
 * FILE     : matrix_multiplication_blocked_runner.cpp
 * AUTHOR   : Sean Tronsen
...
int main() {
    ...
    char data_file_name_01[] = "./dgemm_matrix_multiply_performance_time_data.csv";
    char data_file_name_02[] = "./dgemm_matrix_multiply_performance_flops_data.csv";
